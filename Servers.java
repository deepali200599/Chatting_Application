...
public class Servers implements ActionListener {
    ...
    Servers() {
        ...
        ImageIcon il = new ImageIcon(ClassLoader.getSystemResource("3.png"));
        ...
        JLabel name = new JLabel("Deepali shukla");
        ...
        // mssg.setLayout(new BorderLayout());
        // mssg.add(vertical,BorderLayout.PAGE_START);
        // scrollpane.setBounds(59,89,350,350);
    ...
    try{
     ServerSocket s=new ServerSocket(1024);//port number
                 ...
                 try{
                  ...
                  JPanel panel=formatLabel(msg);
                    ...
                    // SwingUtilities.invokeLater(()->{
                        vertical.add(left);
                        vertical.add(Box.createVerticalStrut(15));
                        serv.a1.add(vertical,BorderLayout.PAGE_START);
